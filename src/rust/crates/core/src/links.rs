...
mod tests {
    ...
    fn probit_matches_pnorm_at_tabulated_points() {
        let cases = [
            (0.0, 0.5),
            (0.5, 0.691_462_461_274_013_01),
            (1.0, 0.841_344_746_068_542_93),
            (-1.0, 0.158_655_253_931_457_05),
            (2.5, 0.993_790_334_674_223_84),
            (-2.5, 0.006_209_665_325_776_134_9),
            (3.0, 0.998_650_101_968_369_9),
            (-3.0, 0.001_349_898_031_630_094_6),
            (5.0, 0.999_999_713_348_428_08),
            (-5.0, 2.866_515_718_791_939_1e-7),
            (8.0, 0.999_999_999_999_999_33),
            (-8.0, 6.220_960_574_271_784_9e-16),
            (0.674_489_750_196_082_04, 0.750_000_000_000_000_11),
        ];
    ...
    fn probit_density_matches_dnorm() {
        let cases = [
            ...
            (8.0, 5.052_271_083_536_892_7e-15),
        ];
        for (eta, expected) in cases {
    ...
    fn logit_matches_plogis() {
        let cases = [
            ...
            (2.0, 0.880_797_077_977_882_31),
            (-2.0, 0.119_202_922_022_117_55),
            (4.0, 0.982_013_790_037_908_45),
        ];
        for (eta, expected) in cases {
    ...
    fn cloglog_matches_reference() {
        let inv = [
            (0.0, 0.632_120_558_828_557_67),
            (1.0, 0.934_011_964_154_687_46),
            (-1.0, 0.307_799_372_444_653_61),
            (0.5, 0.807_704_354_452_035_03),
